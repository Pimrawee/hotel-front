...
import th.ac.ku.hotelFrontend.model.RoomType;
...
public class HomeController {
    ...
    public void ActionOnSearchBtn(ActionEvent event) throws IOException {
    ...
    public void ActionOnCheckBookingBtn(ActionEvent event) throws IOException {
        ...
        stage.setScene(new Scene(loader.load()));
        checkBookingController checkBookingController = loader.getController();
    }
